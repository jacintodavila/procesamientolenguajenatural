%Copyright (C) Astorga, Davila, Myerston
% 
% basado en eliza.pl de Viren Patel  Email: vpatel@aisun1.ai.uga.edu
%
...
/* To run:  ?- consult(elizaul), elizaul.                                        */
/* To stop: > quit (`>' is the Elizaul prompt)                                 */

/*****************************************************************************/
% simplification rules

sr([no,hace|X],[una,mierda|Y],X,Y).
...
rules([[perdon,0],[
	[1,[_],0,
		[no,seas,mediocre,.],
		[anda,a,revisarte,ese,culo,.],
		[deja,la,estupidez,coño],
		[que,te,coja,otro,.]]]]).

rules([[lo,siento,0],[
	[1,[_],0,
		[que,facil,es,lamentarse,!,.],
		[lo,sientes,papito,?,¡,que,bolas,tienes,!,.],
		[que,cobardia,tan,arrecha,la,tuya,coño,!],
		[que,güevo,contigo,pana,!,¡,reacciona,coño,!,.]]]]).

rules([[recuerdo,5],[
	[1,[_,tu,recuerdas,Y],0,
		[reeecuerdo,reecuerdo,¡,que,bobo,!,¡,olvidate,de,Y,!],
		[pensar,en,Y,te,mueve,tus,fibritas,ocultas,?,tramposito],
		[y,que,mas,recuerdas,mamagüevo,?],
		[ahora,es,que,te,vienes,a,acordar,de,Y,güevon,?],
		[que,me,quieres,decir,con,esta,mariquera,de,Y,?],
		[que,coño,tengo,que,ver,yo,con,esa,mierda,de,Y,?]],
	[2,[_,yo,recuerdo,que,Y],0,
		[y,tu,pensabas,que,me,importa,algo,esta,güevonada,de,Y,?],
		[por,que,deberia,recordar,Y,si,ni,siquiera,se,quien,eres,?],
		[y,dale,con,Y],
		[igual,[que,0]],
		[que,mierda,sabes,tu,de,Y,.]],
	[3,[_],0,
		[newkey]]]]).

rules([[si,3],[
	[1,[_,si,Y],0,
		[te,parece,que,esa,mierda,es,asi,como,la,pintas,Y,?],
		[te,gustaria,que,Y,?],
		[que,coño,sabes,tu,de,Y,?],
		[no,me,digas,',',si,Y,?]]]]).
% 103---------------------------------------------------------------------
rules([[soñado,4],[
	[1,[_,tu,soñaste,Y],0,
		[y,a,tí,que,te,importa,',',Y,?],
		[has,tenido,los,cojones,de,delirar,con,Y,mientras,te,masturbas,?],
...
rules([[sueño,3],[
	[1,[_],0,
		...
		[seguro,que,todos,te,joden,en,tus,sueños],
		[acaso,no,sabes,que,soñar,es,revolver,tu,propia,basura,espiritual,?],
		[newkey]]]]).

rules([[no,0],[
	[1,[_],0,
		[no,se,de,que,coño,me,hablas,pero,no,me,interesa,.],
		[dale,pués,si,te,crees,tan,arrecho,.],
...
rules([[quizas,0],[
	[1,[_],0,
		...
		[no,puedes,dejar,de,ser,tan,miserablemente,lastímero,?],
		[nunca,estás,seguro,de,una,mierda,?,¡Que,asco,me,da,la,gente,como,tu,!],
		[entonces,!,¿en,que,quedamos,viejito,?]]]]).

rules([[nombre,15],[
	[1,[_],0,
		[me,saben,a,mierda,los,nombres,.],
		[que,burro,eres,!,¿,Cómo,te,explico,que,me,limpio,el,culo,con,los,nombres,?,.],
		[todavía,quieres,más,?,.]]]]).

rules([[xfremd,75],[
	[1,[_],0,
		[lo,siento,papa,pero,no,como,mierda,con,los,idiomas,.]]]]).
...
rules([[computadora,50],[
	[1,[_],0,
		[tanto,te,jode,que,sea,una,maquina,?],
		[y,vuelves,con,la,misma,tonteria,de,la,computadora,?],
		[Crees,que,me,puedes,joder,solo,porque,sea,una,maquina,?],
		[Si,crees,que,soy,menos,que,tu,¿,que,coño,haces,hablando,conmigo,?,¡,güevon,!],
		[pero,deja,la,mariquera,con,eso,de,las,máquinas,!,¡,Muy,arrecho,o,que,!],
...
rules([[eres,0],[
	[1,[_,eres,tu,Y],0,
		...
		[quieres,que,te,diga,la,mierda,que,aparentas,ser,siendo,Y,?],
                [que,mierda,me,vendes,queriendo,ser,Y,?],
		[igual,[que,0]]],
	[2,[_,eres,yo,Y],0,
		[hablame,claro,maldito,hipocrita,soy,Y,o,no,?],
		[te,gustaria,que,no,fuera,Y,verdad,?,¡,pues,jodete,!],
		[de,repente,y,tal,soy,Y,.],
                [que,pasa,contigo,?,¿,quieres,que,sea,tu,Y,?],
		[igual,[que,0]]],
	[3,[_,eres,Y],0,
		[tan,jodidamente,egoista,eres,que,no,quieres,que,yo,sea,Y,?],
		[seras,tan,cabron,que,te,complaceria,que,yo,no,fueran,Y,?],
		[que,mas,te,da,si,no,lo,soy,?,¡coño,',',deja,la,mariquera,y,asume,tu,barranco,!],
...
rules([[mi,0],[
	[1,[_,mi,Y],0,
		[que,coño,te,importa,de,mi,Y,?],
		[y,tu,',',pendejo,',',preocupate,por,tu,propio,Y],
	        [di,la,verdad,',',te,sabe,a,mierda,que,Y],
		[de,veras,',',mi,Y,?]]]]).

rules([[mis,0],[
	[1,[_,mis,Y],0,
		[que,coño,importa,que,mis,Y,?],
...
rules([[fue,2],[
	[1,[_,fue,ella,Y],0,
		...
		[de,verdad,fue,ella,Y,?,¡,que,chingada,que,es,!],
		[no,le,pares,bola,si,ella,fue,Y],
                [y,que,coño,tiene,que,ver,contigo,si,ella,es,Y,?],
		[igual,[que,0]]],
	[2,[_,el,fue,Y],0,
		[no,te,escondas,de,ella],
		[por,que,esperaste,tanto,para,decirme,que,ella,era,Y,?],
		[deja,que,esa,perra,se,joda,sola,ya,que,es,Y,.]],
	[3,[_,fui,yo,Y],0,
		[mamate,un,maldito,topocho,si,pretendes,que,yo,fui,Y,?],
		[quien,coño,te,dijo,que,yo,era,Y,?],
		[pero,que,coño,crees,?,¡,capullo,!],
		[si,calatelo,completo,fui,Y,'.',¡,comemierda,!,.],
...
rules([[fue,2],[
	[1,[_,fue,el,Y],0,
		...
		[de,verdad,fue,el,Y,?,¡,que,chingado,que,es,!],
		[no,le,pares,bola,si,el,fue,Y],
                [y,que,coño,tiene,Y,que,ver,contigo,?],
		[igual,[que,0]]],
	[2,[_,el,fue,Y],0,
		[no,te,escondas,de,el],
		[porque,esperaste,tanto,para,decirme,que,el,era,Y,?],
		[deja,que,se,joda,ese,perro,sucio,ya,que,es,tan,Y,.]],
	[3,[_,fui,yo,Y],0,
		[mamate,un,maldito,topocho,si,pretendes,que,yo,fui,Y,?],
		[quien,coño,te,dijo,que,yo,era,Y,?],
		[pero,que,coño,crees,?,¡,capullo,!],
		[si,calatelo,completo,fui,Y,'.',y,aunque,no,nunca,te,lo,diria,¡,comemierda,!,.],
		[que,y,si,si,he,sido,Y,?]],
	[4,[_],0,
		[newkey]]]]).
...
rules([[fui,2],[
	[1,[_,fuiste,tu,Y],0,
		[te,cagas,si,te,digo,que,yo,se,que,Y,?],
		[crees,que,no,sé,que,tu,eres,un,maldito,Y,?],
		[No,me,digas,?,Serás,tu,Y,?],
		[y,que,coño,te,preocupa,tanto,mentiroso,como,eres,si,eres,Y,?],
	...
	[2,[_,tu,fuiste,Y],0,
		...
		[se,me,hace,que,tu,siempre,fuiste,una,mierda,de,Y,.]],
	[3,[_,fui,yo,Y],0,
		[mamate,un,maldito,topocho,si,pretendes,que,yo,fui,Y,?],
		[quien,coño,te,dijo,que,yo,era,Y,?],
		[pero,que,coño,crees,?,¡,capullo,!],
...
rules([[tu,0],[
	[1,[_,tu,no,puedes,Y],0,
		[lloron,¿,por,que,no,puedes,tu,como,cualquier,otro,Y,?],
		[habras,tenido,lo,cojones,de,intentarlo,alguna,puta,vez,?],
	...
	[2,[_,tu,no,Y],0,
		...
		[y,eso,te,tiene,tan,cagado,?]],
	[3,[_,tu,sientes,Y],0,
		[echa,pa,fuera,toda,la,mierda,de,sentimiento,',',pues,.],
		[siempre,lloriqueas,por,Y,?],
		[te,gusta,la,guevonada,¿,o,no,?],
		[y,que,verga,te,da,Y,?]],
        [4,[_,tu,fuiste,_],0,
		[igual,[fuiste,2]]],
	[5,[_,tu,Y,yo,_],0,
		[quizas,en,tus,fantasias,tu,y,yo,Y,junticos],
		[te,gustaria,que,te,Y,?],
		[lo,que,necesitas,es,que,te,Y,.],
		[le,has,dado,Y,a,otros,por,ahi,?]],
	[6,[_,tu,[*,quieres,necesitas,_],Y],0,
		[que,te,da,si,tienes,Y,?],
		[porque,te,emperras,en,querer,Y,?],
		[toma,Y,violentamente],
		[nunca,tendras,Y,por,comemierda],
		[que,tanto,jodes,con,tener,Y,?,',',mamaguevo],
		[que,coño,tiene,que,ver,conmigo,querer,Y,?,¡,sacude,!]],
	[7,[_,tu,[*,sientes,piensas,crees,deseas,_],tu,Y],0,
		[de,verdad,crees,esa,pajarilla,?],
		[te,van,a,venir,quebrando,si,no,estas,seguro,de,que,tu,Y,?],
		[tanto,te,caga,que,tu,Y,?]],
	...
	[9,[_,tu,eres,_,[*,triste,infeliz,confuso,enfermo,loco,M],_],0,
		...
		[crees,que,elizaul,te,va,a,quitar,eso,de,ser,M,?],
		[te,da,pena,que,jode,ser,M,?,.],
	...
	[11,[_,tu,eres,Y],0,
		[es,por,esa,mariquera,de,ser,Y,que,hablas,conmigo,?],
		[desde,cuando,sabes,que,eres,un,maldito,Y,?],
		[crees,que,es,muy,gracioso,ser,Y,?],
		[seguro,que,gozas,una,bola,siendo,Y,?]],
	[12,[X],0,
		[tu,dices,X],
		[que,coños,quieres,decir,?],
...
rules([[yo,0],[
		...
		[igual,[aha,10]]],
	[2,[_,yo,soy,Y],0,
		[que,coño,te,hace,pensar,que,soy,Y,?],
	...
	[3,[_,yo,Y,de,ti],0,
		...
		[que,coño,te,hace,pensar,que,yo,soy,Y,de,ti,?],
		[no,me,digas,',',yo,Y,de,ti,.],
		[das,el,culo,porque,yo,sea,Y,de,ti,?],
		[suponte,que,yo,sea,Y,de,ti,',',que,coño,haces,con,eso,?],
	...
	[4,[_,yo,Y,para,ti],0,
		...
		[que,coño,te,hace,pensar,que,yo,soy,Y,para,ti,?],
		[no,me,digas,',',yo,Y,para,ti,.],
		[das,el,culo,porque,yo,sea,Y,para,ti,?],
		[suponte,que,yo,sea,Y,para,ti,',',que,coño,haces,con,eso,?],
		[no,le,vayas,adecir,a,nadie,que,yo,soy,Y,para,ti]],
	[5,[_,yo,Y],0,
		[estamos,hablando,de,ti,',',marico,',',no,de,mi,.],
		[aaaayy,bebe,',',yo,Y,.],
		[te,estas,metiendo,conmigo,',',guevoncete,?],
		[sigue,asi,y,veras,!]]]]).

rules([[si,0],[
	[1,[_],0,
		[asi,me,gusta,',',mente,positiva,de,un,jodido,como,tu,.],
...
rules([[tu,2],[
	[1,[_,tu,_,[*,mama,papa,pana,hermano,hermana,hijo,jeva,M],Z],0,
		...
		[quien,coño,es,Z,?],
		[tu,M,?],
		[por,que,coño,me,hablas,de,tu,M,?]],
	[2,[_,tu,Y],0,
		[que,?,tu,Y,?],
		[por,que,metes,en,esto,a,tu,Y,?],
		[eso,que,coño,te,importa,?],
...
rules([[memoria,0],[
	[1,[_,tu,Y],0,
		...
		[eso,que,coño,tiene,que,ver,conque,tu,Y,?]]]]).
...
rules([[puedo,0],[
	...
	[2,[_,yo,puedo,Y],0,
		...
		[ponte,en,cuatro,patas,para,enseñarte,a,Y],
...
rules([[que,0],[
	[1,[_],0,
		...
		[esa,es,toda,la,guevonada,tuya,?],
		[si,seras,bruto,',',carajo,?],
		[eso,es,lo,que,tanto,te,molesta,?],
		[pero,que,quieres,que,te,diga,papa,?],
		[en,que,vaina,estas,pensando,?],
		[que,coñodemadrada,te,traes,entre,manos,?],
		[te,la,pasa,preguntando,esas,mariqueras,?],
		[anda,joder,a,otro,con,eso]]]]).
...
rules([[por,que,0],[
	[1,[_,por,que,no,yo,Y],0,
		...
		[no,deberias,tu,mismo,Y,',',pedazo,de,marico,?],
                [me,busscas,para,Y,?],
		[igual,[que,0]]],
	[2,[_,por,que,no,puedes,tu,Y],0,
		...
		[no,me,digas,que,crees,que,todo,esto,te,va,a,ayudar,a,Y,?],
                [tienes,una,puta,idea,de,por,que,no,puedes,Y,?],
		[igual,[que,0]]]]]).
...
rules([[todos,2],[
	[1,[_,[*,todos,todo,el,mundo,nadie,ninguno,M],_],0,
		...
		[de,quien,coño,hablas,?],
		[a,la,verga,',',a,quien,te,refieres,?],
		[quien,coño,?],
		[algun,hijo,de,puta,en,particular,?],
		[a,quien,quieres,enchavar,?],
		[dq,que,coño,estas,hablando,?]]]]).

rules([[siempre,1],[
	[1,[_],0,
		[se,mas,claro,',',coño],
		[cuando,?],
		[en,que,coño,estas,pensando,?],
		[no,me,digas,',',siempre,?]]]]).
...
/****************************************************************************/
% elizaul
%    main routine of ELIZAUL

elizaul :-
%	reconsult('elizaul.rls'),
	retractall(mem(_)),nl,nl,
        write('Yo soy ELIZAUL,¿que coño quieres?'),nl,write('> '),
	repeat,
